...
class Check(object):
    ...
    def get_input_args():
        ...
        input_argv = sys.argv
        input_dict = {}
        check_list = ['-f', '-out', '-detail', '-t', '-le', '-ge', '-db_name', '-col_name', '-freq', '-top', '-gui']
        to_summary = False
        ...
        if input_dict.get('-ge') != None:
            if input_dict.get('-out') not in ['summary_by_time','summary_by_date','summary_by_count','summary_by_count_lv1','summary_by_count_lv2','summary_by_count_lv3']:
        ...
        try:
            ...
            if input_dict.get('-out') in ['summary_by_time','summary_by_date','summary_by_count','summary_by_count_lv1','summary_by_count_lv2','summary_by_count_lv3']:
                to_summary = True
            else:
                msg.general_input_error()
